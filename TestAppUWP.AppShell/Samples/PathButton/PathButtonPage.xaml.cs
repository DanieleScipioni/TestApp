    ...
    public sealed partial class PathButtonPage : INotifyPropertyChanged
    {
        ...
        private void SetNavigationViewHeaderTemplate()
        {
            if (visualStateGroup.CurrentState != null)
            {
                ...
                {
                    case "BigVisualState":
                        ContentControl.ContentTemplate = Resources["BigHeaderTemplate"] as DataTemplate;
                        bottomCommandBar.Visibility = Visibility.Collapsed;
                        break;
                    case "SmallVisualState":
                        ContentControl.ContentTemplate = Resources["SmallHeaderTemplate"] as DataTemplate;
